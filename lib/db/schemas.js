...
ALTER TABLE reports ADD COLUMN IF NOT EXISTS photo_id bigint;
ALTER TABLE reports ADD COLUMN IF NOT EXISTS check_accurate boolean;
ALTER TABLE reports ADD COLUMN IF NOT EXISTS check_seen text;
ALTER TABLE reports ADD COLUMN IF NOT EXISTS check_nlu text;
...
ALTER TABLE reports ADD COLUMN IF NOT EXISTS contractor text;
ALTER TABLE reports ADD COLUMN IF NOT EXISTS photo_kind text;
CREATE INDEX IF NOT EXISTS reports_hash ON reports (hash);
CREATE INDEX IF NOT EXISTS reports_photo ON reports (photo_id);
`,
...
ALTER TABLE settings ADD COLUMN IF NOT EXISTS vision_model text;
`,
...
CREATE INDEX IF NOT EXISTS photos_hash_at ON photos (hash, at DESC);
CREATE INDEX IF NOT EXISTS photos_road ON photos (road_key);
CREATE INDEX IF NOT EXISTS photos_report ON photos (report_id);
ALTER TABLE photos ADD COLUMN IF NOT EXISTS report_id bigint;
ALTER TABLE photos ADD COLUMN IF NOT EXISTS photo_kind text;
...
ALTER TABLE photos ADD COLUMN IF NOT EXISTS where_text text;
ALTER TABLE photos ADD COLUMN IF NOT EXISTS contractor text;
`
};
