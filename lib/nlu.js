 ...
 *   NLU_TIMEOUT_MS override (hosted default 8000, local Ollama 45000)
 */
...
const INTENTS = new Set([
  ...
  'incident_history', 'fuel', 'queue', 'road', 'cheapest', 'fare', 'station', 'chart'
]);
...
module.exports = {
  INTENTS, infer, lexicalMatch, looksLikeAddonControl, status, sanitize, prompt, ready, setGazetteer
};
